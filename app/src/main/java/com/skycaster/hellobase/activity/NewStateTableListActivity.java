...
import com.skycaster.hellobase.adapter.NewStListAdapter;
...
public class NewStateTableListActivity extends BaseActivity {
    ...
    private NewStListAdapter mAdapter;

    public static void start(Context context,ArrayList<StateTable>list) {
        Intent starter = new Intent(context, NewStateTableListActivity.class);
    ...
    protected void initData() {
        ...
        sortTables(list);
        mAdapter=new NewStListAdapter(mList,this);
...
//                StateActivity.start(NewStateTableListActivity.this,table);
//            }
//        });
        mAdapter.setOnItemClickListener(new NewStListAdapter.OnItemClickListener() {
            @Override
    ...
    public void onBackPressed() {
        AlertDialogUtil.showBaseDialog(this, "温馨提示", "您确定要退出本程序吗？", new View.OnClickListener() {
            ...
            public void onClick(View v) {
                NewStateTableListActivity.super.onBackPressed();
            }
        });
    }
}
